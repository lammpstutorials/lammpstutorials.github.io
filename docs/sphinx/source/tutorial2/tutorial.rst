...
.. figure:: figures/colored-edge-undef-dark.png
    :alt: CNT in graphene in vacuum image VMD
    :class: only-dark

.. figure:: figures/colored-edge-undef-light.png
    :alt: CNT in graphene in vacuum image VMD
    :class: only-light
...
.. figure:: figures/colored-edge-deleted-dark.png
    :alt: CNT in graphene in vacuum image VMD with deleted atoms
    :class: only-dark

.. figure:: figures/colored-edge-deleted-light.png
    :alt: CNT in graphene in vacuum image VMD with deleted atoms
    :class: only-light
...
.. figure:: figures/length-unbreakable.png
    :alt: length of the CNT with time - lammps molecular dynamics
    :class: only-light

.. figure:: figures/length-unbreakable-dm.png
    :alt: length of the CNT with time - lammps molecular dynamics
    :class: only-dark
...
.. figure:: figures/energy-unbreakable-dm.png
    :alt: energy of the CNT with time - lammps molecular dynamics
    :class: only-dark

.. figure:: figures/energy-unbreakable.png
    :alt: energy of the CNT with time - lammps molecular dynamics
    :class: only-light
...
.. figure:: figures/energy-breakable-dm.png
    :alt: energy of the CNT with time - lammps molecular dynamics
    :class: only-dark

.. figure:: figures/energy-breakable.png
    :alt: energy of the CNT with time - lammps molecular dynamics
    :class: only-light
