...
.. figure:: ../figures/level1/graphene-under-deformation/graphene_dark.png
    :alt: graphene in vacuum image VMD
    :width: 250
    :align: right
    :class: only-dark

.. figure:: ../figures/level1/graphene-under-deformation/graphene_light.png
    :alt: graphene in vacuum image VMD
    :width: 250
    :align: right
    :class: only-light
...
.. figure:: ../figures/level1/graphene-under-deformation/vmd_dark.png
    :alt: graphene in vacuum image VMD
    :width: 250
    :align: right
    :class: only-dark

.. figure:: ../figures/level1/graphene-under-deformation/vmd_light.png
    :alt: graphene in vacuum image VMD
    :width: 250
    :align: right
    :class: only-light
...
.. |download_carbon_data| raw:: html
   ...
   <a href="../../../../../inputs/level1/graphene-under-deformation/carbon.data" target="_blank">here</a>
...
.. figure:: ../figures/level1/graphene-under-deformation/group-dark.png
    :alt: graphene in vacuum image VMD with selected groups at the edges
    :class: only-dark

.. figure:: ../figures/level1/graphene-under-deformation/group-light.png
    :alt: graphene in vacuum image VMD with selected groups at the edges
    :class: only-light
...
.. figure:: ../figures/level1/graphene-under-deformation/strain-stain-curve-dark.png
    :alt: strain stain curve for determining the young modulus of graphene
    :class: only-dark

.. figure:: ../figures/level1/graphene-under-deformation/strain-stain-curve-light.png
    :alt: strain stain curve for determining the young modulus of graphene
    :class: only-light
