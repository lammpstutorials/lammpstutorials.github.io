...
The potential and force along the :math:`x` axis resembles:

.. figure:: figures/potential.png
   :alt: Imposed potential
   :class: only-light

.. figure:: figures/potential-dm.png
...
.. figure:: figures/density_evolution.png
   :alt: Number of particles in the central region as a function of time
   :class: only-light

.. figure:: figures/density_evolution-dm.png
   :alt: Number of particles in the central region as a function of time
   :class: only-dark
...
.. figure:: figures/density_profile.png
   :alt: Averaged density profile
   :class: only-light

.. figure:: figures/density_profile-dm.png
   :alt: Averaged density profile
   :class: only-dark
...
.. figure:: figures/freesampling-potential-light.png
   :alt: Averaged density profile
   :class: only-light

.. figure:: figures/freesampling-potential-dark.png
   :alt: Averaged density profile
   :class: only-dark
...
.. figure:: figures/density_profile_large_potential-light.png
   :alt: Averaged density profile with large potential
   :class: only-light

.. figure:: figures/density_profile_large_potential-dark.png
...
Here, :math:`k` is in kcal/mol. The generated file named *metadata.dat* looks
like this:
...
Alternatively, you can download this |download_metadata| file. Then, simply run
...
.. figure:: figures/freeenergy.png
    :alt: Result of the umbrella sampling
    :class: only-light

.. figure:: figures/freeenergy-dm.png
    :alt: Result of the umbrella sampling
    :class: only-dark
